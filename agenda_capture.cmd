...
wsl -e bash -c "cd /mnt/c/Users/Tarek/Documents/tributary_tracer && .venv/bin/python agenda.py --capture >> agenda/capture.log 2>&1 && .venv/bin/python agenda.py --universe >> agenda/capture.log 2>&1"
